...
class Node():
    def __init__(self):
        ...
        self.client_list_server = []   #client(連接別人) 列表
            #白名單
        #self.node_list = ['192.20.10. 5000', '10.1.1.35 5001', '10.1.1.35 5002', '10.1.1.35 5003']
        #self.ip_list = ['10.1.1.123', '10.1.1.35', '10.1.1.35', '10.1.1.35']
        self.node_list = ['172.20.10.13 5000','172.20.10.14 5001','172.20.10.5 5002','172.20.10.2 5003']
        self.ip_list = ['172.20.10.13', '172.20.10.14', '172.20.10.5', '172.20.10.2']
